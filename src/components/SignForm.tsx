...
const SignForm = ({ signup }: SignFormProps) => {
  ...
  const [inputErrors, setInputErrors] = useState<{ email: { error: boolean; message: string }; password: { error: boolean; message: string }; passwordCheck: { error: boolean; message: string } }>({
